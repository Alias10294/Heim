#ifndef HEIM_META_TYPE_SEQUENCE_HPP
#define HEIM_META_TYPE_SEQUENCE_HPP
...
template<
    ...
    template<typename, typename>
    typename>
struct type_sequence_fold_left;
...
template<
    ...
    template<typename, typename>
    typename Op>
using type_sequence_fold_left_t
= typename type_sequence_fold_left<T, Init, Op>::type;
...
struct type_sequence_fold_left<
    ...
    Init,
    Op>
  : type_sequence_fold_left<
        type_sequence<Ts ...>,
        typename Op<Init, T>::type,
        Op>
{ };
...
template<
    ...
    template<typename, typename>
    typename>
struct type_sequence_fold_left_first;

template<
    typename T,
    template<typename, typename>
    typename Op>
using type_sequence_fold_left_first_t
= typename type_sequence_fold_left_first<T, Op>::type;
...
template<
    ...
    template<typename, typename>
    typename>
struct type_sequence_fold_right;
...
template<
    ...
    template<typename, typename>
    typename Op>
using type_sequence_fold_right_t
= typename type_sequence_fold_right<T, Init, Op>::type;
...
template<
    ...
    template<typename, typename>
    typename>
struct type_sequence_fold_right_last;

template<
    typename T,
    template<typename, typename>
    typename Op>
using type_sequence_fold_right_last_t
= typename type_sequence_fold_right_last<T, Op>::type;
...
struct type_sequence_fold_right_last<
  ...
  : Op<
        First,
        type_sequence_fold_right_last_t<
            type_sequence<Second, Rest...>,
            Op>>
{ };
...
struct type_sequence<T, Ts ...>
{
  ...
  = type_sequence_fold_left_first_t<type_sequence, Op>;

  template<
      template<typename, typename>
      typename Op>
  using fold_right_last
  = type_sequence_fold_right_last_t<type_sequence, Op>;
  ...
  template<
      ...
      typename Op>
  using fold_left
  = type_sequence_fold_left_t <type_sequence, Init, Op>;

  template<
      typename Init,
      template<typename, typename> typename Op>
  using fold_right
  = type_sequence_fold_right_t<type_sequence, Init, Op>;
};
...
#endif // HEIM_META_TYPE_SEQUENCE_HPP
